            ...
            <Popover>
              <Popover.Body className = 'p-0'>
                <div className="list-group">
                    <button type="button" onClick = {()=>homeViewModel.setShowJoinClassModal(true)} className="list-group-item list-group-item-action">Tham gia lớp học</button>
                    <button type="button" onClick = {()=>homeViewModel.setShowCreateClassModal(true)} className="list-group-item list-group-item-action">Tạo lớp học</button>             
                </div>
              </Popover.Body>
            </Popover>
          }>
